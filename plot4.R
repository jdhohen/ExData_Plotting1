...
legend("topright",legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col= c("black", "red", "blue"), lwd = 1, bty = "n", cex = 0.5)


#top right
plot(Data$Datetime, Data$Voltage, lines(Data$Datetime, Data$Voltage), type="l", xlab = "datetime", ylab = "Voltage")


#bottom right
plot(Data$Datetime, Data$Global_reactive_power, lines(Data$Datetime, Data$Global_reactive_power), type="l", xlab = "datetime", ylab = "Global_reactive_power")
